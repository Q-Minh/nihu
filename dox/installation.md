...
In order to use the functions of the Matlab interface, you should add the Matlab interface path of your NiHu installation to the search path of Matlab. This can be done by executing the following commands inside Matlab.

	addpath('/path/to/nihu_install/matlab')
	savepath

This will enable you to call NiHu's Matlab and mex functions from any of your Matlab scripts.
