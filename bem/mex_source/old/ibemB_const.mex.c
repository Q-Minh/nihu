...
/* $Make: mex -O -output ibemB_const ibemB_const.mex.c ibemB_con.c mesh.c integral_indirect.c quadrature.c element.c vector.c green.c $ */
                 ...
                 const mxArray *prhs[])
{
    ...
    if (nrhs == 6)
    {
        ...
        /* call C subroutine */
        iBEM_B_surf_const(nnodes, nodes, nelements, elements,
                          g3, g4, dist, k, Br, Bi);
    }
    else if (nrhs == 7)
    {
