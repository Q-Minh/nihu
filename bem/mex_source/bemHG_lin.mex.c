...
/* $Make: mex -O -output bemHG_lin bemHG_lin.mex.c bemHG_li.c mesh.c integral_direct.c quadrature.c element.c vector.c green.c $ */
                 ...
                 const mxArray *prhs[])
{
    ...
    if (nrhs == 6)
    {
        ...
        /* call C subroutine */
        matrix_surf_lin(nnodes, nodes, nelements, elements, g3, g4, dist, k, Ar, Ai, Br, Bi);
    }
    else if (nrhs == 7)
    {
        ...
        /* call C subroutine */
        matrix_field_lin(nnodes, nodes, nelements, elements, npoints, points, g3, g4, dist, k, Ar, Ai, Br, Bi);
    }
