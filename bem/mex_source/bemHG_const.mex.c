 ...
 *   [H, G] = bemHG_const(nodes, elements, g3, g4, dist, k, points)
...
/* $Make: mex -O -output bemHG_const bemHG_const.mex.c bemHG_con.c mesh.c integral_direct.c quadrature.c element.c vector.c green.c$ */
