                       ...
                       double *Bi)
{
    ...
    for (ex = 0; ex < nelements; ex++)
    {
        ...
        {
        case 3:
            dint_tri_const_sing(&g3[0], nodx, &accelerators[ex], &g4[0], k, &br, &bi);
            break;
        case 4:
            dint_quad_const_sing(&g4[0], nodx, &accelerators[ex], k, &br, &bi);
            break;
        }
        ...
        for (ey = ex+1; ey < nelements; ey++)
        {
            ...
            case 4:
                ...
                {
                case 4:
                    dint_quadquad_const(&g4[gs], nodx, &accelerators[ex], nody, &accelerators[ey], k, &br, &bi);
                    break;
                case 3:
                    dint_triquad_const(&g3[gs], nody, &accelerators[ey], &g4[gs], nodx, &accelerators[ex], k, &br, &bi);
                    break;
                }
                break;
            case 3:
                ...
                {
                case 4:
                    dint_triquad_const(&g3[gs], nodx, &accelerators[ex], &g4[gs], nody, &accelerators[ey], k, &br, &bi);
                    break;
                case 3:
                    dint_tritri_const(&g3[gs], nodx, &accelerators[ex], nody, &accelerators[ey], k, &br, &bi);
                    break;
                }
            }
