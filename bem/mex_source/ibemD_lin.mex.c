/*ibemD_lin  Generate acoustic BEM system matrices
 *   D = ibemD_lin(nodes, elements, g3, g4, dist, k, points)
...
/* $Make: mex -O -output ibemD_lin ibemD_lin.mex.c ibemD_li.c mesh.c integral_indirect.c quadrature.c element.c green.c vector.c$ */
                 ...
                 const mxArray *prhs[])
{
    ...
    if (nrhs == 6)
    {
        ...
        /* call C subroutine */
        iBEM_D_surf_lin(nnodes, nodes, nelements, elements,
                        g3, g4, dist, k, Dr, Di);
    }
    else if (nrhs == 7)
    {
