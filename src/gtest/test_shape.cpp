...
static_assert(std::is_same<line_0_shape_set::domain_t, line_domain>::value, "Tria 1 shape set domain failure");
static_assert(line_0_shape_set::num_nodes == 1, "Tria 1 shape set number of nodes failure");
static_assert(line_0_shape_set::polynomial_order == 0, "Tria 1 shape set polynomial order failure");
static_assert(line_0_shape_set::jacobian_order == 0, "Tria 1 shape set Jacobian order failure");
static_assert(line_0_shape_set::id == 1201, "Tria 1 shape set id failure");
static_assert(std::is_same<line_0_shape_set::scalar_t, double>::value, "Tria 1 shape set scalar failure");
static_assert(std::is_same<line_0_shape_set::xi_t, Eigen::Matrix<double, 1, 1> >::value, "Tria 1 shape set xi_t failure");
...
static_assert(std::is_same<line_1_shape_set::xi_t, Eigen::Matrix<double, 1, 1> >::value, "Tria 1 shape set xi_t failure");
