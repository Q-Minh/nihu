...
/** \file elastodynamics_singular_integrals.hpp
 * \brief Analytical expressions for the singular integrals of elastodynamic kernels
 */
#ifndef ELASTODYNAMICS_SINGULAR_INTEGRALS_HPP_INCLUDED
#define ELASTODYNAMICS_SINGULAR_INTEGRALS_HPP_INCLUDED
...
class singular_integral_shortcut<
	elastodynamics_3d_T_kernel, TestField, TrialField, match::match_2d_type,
...
public:
	...
	static result_t &eval(
		...
		element_match const &)
	{
		typedef guiggiani<TrialField, elastodynamics_3d_T_kernel, 5, 9> guiggiani_t;
...
#endif // ELASTODYNAMICS_SINGULAR_INTEGRALS_HPP_INCLUDED
