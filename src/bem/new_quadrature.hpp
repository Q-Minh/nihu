#ifndef NEW_QUADRATURE_HPP_INCLUDED
#define NEW_QUADRATURE_HPP_INCLUDED
...
public:
	...
	typedef typename base::quadrature_elem_t::xi_t xi_t;
...
public:
	...
	typedef typename base::quadrature_elem_t quadrature_elem_t;
	...
	gauss_quadrature(unsigned degree) : quadrature<tria_domain>(dunavant_num[degree])
	{
		...
		case 7:
			...
			/*
		case 8:
			push_back(quadrature_elem_t(xi_t(0.333333333333333   0.333333333333333
			push_back(quadrature_elem_t(xi_t(0.459292588292723   0.081414823414554
			push_back(quadrature_elem_t(xi_t(0.459292588292723   0.459292588292723
			push_back(quadrature_elem_t(xi_t(0.081414823414554   0.459292588292723
			push_back(quadrature_elem_t(xi_t(0.170569307751760   0.658861384496480
			push_back(quadrature_elem_t(xi_t(0.170569307751760   0.170569307751760
			push_back(quadrature_elem_t(xi_t(0.658861384496480   0.170569307751760
			push_back(quadrature_elem_t(xi_t(0.050547228317031   0.898905543365938
			push_back(quadrature_elem_t(xi_t(0.050547228317031   0.050547228317031
			push_back(quadrature_elem_t(xi_t(0.898905543365938   0.050547228317031
			push_back(quadrature_elem_t(xi_t(0.263112829634638   0.008394777409958
			push_back(quadrature_elem_t(xi_t(0.728492392955404   0.263112829634638
			push_back(quadrature_elem_t(xi_t(0.008394777409958   0.728492392955404
			push_back(quadrature_elem_t(xi_t(0.008394777409958   0.263112829634638
			push_back(quadrature_elem_t(xi_t(0.263112829634638   0.728492392955404
			push_back(quadrature_elem_t(xi_t(0.728492392955404   0.008394777409958
			ww = [
			0.072157803838894
			0.047545817133642
			0.047545817133642
		...
		case 9
			push_back(quadrature_elem_t(xi_t(0.333333333333333   0.333333333333333
			push_back(quadrature_elem_t(xi_t(0.489682519198738   0.020634961602525
			push_back(quadrature_elem_t(xi_t(0.489682519198738   0.489682519198738
			push_back(quadrature_elem_t(xi_t(0.020634961602525   0.489682519198738
			push_back(quadrature_elem_t(xi_t(0.437089591492937   0.125820817014127
			push_back(quadrature_elem_t(xi_t(0.437089591492937   0.437089591492937
			push_back(quadrature_elem_t(xi_t(0.125820817014127   0.437089591492937
			push_back(quadrature_elem_t(xi_t(0.188203535619033   0.623592928761935
			push_back(quadrature_elem_t(xi_t(0.188203535619033   0.188203535619033
			push_back(quadrature_elem_t(xi_t(0.623592928761935   0.188203535619033
			push_back(quadrature_elem_t(xi_t(0.044729513394453   0.910540973211095
			push_back(quadrature_elem_t(xi_t(0.044729513394453   0.044729513394453
			push_back(quadrature_elem_t(xi_t(0.910540973211095   0.044729513394453
			push_back(quadrature_elem_t(xi_t(0.221962989160766   0.036838412054736
			push_back(quadrature_elem_t(xi_t(0.741198598784498   0.221962989160766
			push_back(quadrature_elem_t(xi_t(0.036838412054736   0.741198598784498
			push_back(quadrature_elem_t(xi_t(0.036838412054736   0.221962989160766
			push_back(quadrature_elem_t(xi_t(0.221962989160766   0.741198598784498
			push_back(quadrature_elem_t(xi_t(0.741198598784498   0.036838412054736
			ww = [
			0.048567898141400
			0.015667350113570
			0.015667350113570
