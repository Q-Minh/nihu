...
template<>
line_domain::corners_t const line_domain::m_corners = {
...
template<>
tria_domain::xi_t const tria_domain::m_center = tria_domain::xi_t::Ones()/3.0;
...
template<>
brick_domain::corners_t const brick_domain::m_corners = {
