...
int main(void)
{
	...
	auto xi1 = NiHu::quad_domain::get_center();
	auto xi2 = NiHu::quad_domain::get_corner(0);
	NiHu::kernel_traits<decltype(K)>::test_input_t tst_i(elem, xi1);
	NiHu::kernel_traits<decltype(K)>::trial_input_t trl_i(elem, xi2);
