...
int main(int argc, char *argv[])
{
	...
	std::string surf_res_name = pattern + "_surf.res";
	std::string field_res_name = pattern + "_field.res";
	...
	double v0 = 1e-3;
	xct.resize(surf_mesh.get_num_elements());
