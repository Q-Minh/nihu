function g = helmholtz_3d_dlpt_nearly_singular(x, nx, corners, k)

% integrate static part analytically
g_stat = laplace_3d_dlpt_nearly_singular(x, nx, corners);
...
ker = helmholtz_3d_dlpt_kernel(x, nx, y, ny, k) ...
    - laplace_3d_dlpt_kernel(x, nx, y, ny);
