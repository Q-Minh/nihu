function g = helmholtz_3d_dlp_nearly_singular(x, ~, corners, k)

% integrate static part analytically
g_stat = laplace_3d_dlp_nearly_singular(x, [], corners);
...
ker = helmholtz_3d_dlp_kernel(x, [], y, ny, k) ...
    - laplace_3d_dlp_kernel(x, [], y, ny);
