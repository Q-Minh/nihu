...
The kernel's gradient (w.r.t. $y_i$) is expressed as
%
\begin{equation}
	G'_i = -\frac{1}{2\pi r} \frac{r_i}{r}
...
%
\begin{equation}
	G''_{ij} = \frac{-1}{2\pi r^2}\left( \delta_{ij} - 2\frac{r_j}{r} \frac{r_i}{r}\right)
\end{equation}
%
The kernel's third derivative tensor is expressed as
%
\begin{equation}
	G'''_{ijk} =
	\frac{1}{\pi r^3}\left( \frac{\delta_{ij}r_k + \delta_{jk}r_i + \delta_{ki}r_j}{r} - 4\frac{r_i}{r} \frac{r_j}{r} \frac{r_k}{r}\right)
\end{equation}

\subsection{Normal derivatives}

The kernel's normal derivative with respect to the normal  ${\bf n}_y$ is expressed as
%
\begin{equation}
	G'_{n_y}
	= G'_i n_{yi}
	= -\frac{1}{2\pi r} \frac{r_i n_{yi}}{r} = -\frac{1}{2\pi r} r'_{n_y}
\end{equation}

The second normal derivative w.r.t $n_x$ and $n_y$ is expressed as
%
\begin{equation}
	G''_{n_x n_y}
	= - G''_{ij} n_{xi} n_{yj}
...
\end{equation}
%
and the second normal derivative w.r.t. ${\bf n}_x$ is expressed as
%
\begin{equation}
	G''_{n_x n_x}
	= G''_{ij} n_{xi} n_{xj}
...
As a consequence, the third normal derivative is expressed as
%
\begin{equation}
	G'''_{n_x n_x n_y}({\bf x}, {\bf y})
	= n_{xi} n_{xj} n_{yk} G''_{ijk}
	= \frac{r'_{n_y}}{\pi r^3}\left( 1 - r'_{n_x} ({\bf n}_{x} {\bf n}_{y})
	- 4 (r'_{n_x})^2  \right)
\end{equation}
